...
class SpeedFragment : Fragment {
    ...
    companion object {
        ...
        fun getInstance(
            ...
            if (instance == null) {
                instance = SpeedFragment(iEditMediaCallback, entityAudio)
            }
            return instance!!
        }
    }
    ...
    override fun onCreateView(
        ...
        root.findViewById<TextCustumFont>(R.id.tv_volume).text = getString(R.string.speed)
        ...
        volumeSeekBar?.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
                if (fromUser) {
                    tvProgress?.text = String.format(Locale.US, "%.2fx", (progress / 375.0f) * 3.75f + 0.25f)
                }
            }
    ...
    fun applyVolume(applyAll: Boolean) {
        ...
        iVolumeCallback?.let {
            if (applyAll) {
                it.updateEntity(EffectAudioType.SPEED, entityAudio!!)
