...
import hazem.nurmontage.videoquran.adapter.TransitionEntityAdabters.TransitionItem
...
class EffectAyaFragment : Fragment {
    ...
    companion object {
        ...
        fun get(
            ...
            resources: Resources?,
            iTransition: TransitionEntityAdabters.ITransition?,
    ...
    private var iTransition: TransitionEntityAdabters.ITransition? = null
